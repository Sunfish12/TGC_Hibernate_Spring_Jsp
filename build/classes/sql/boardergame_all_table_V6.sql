...
groupRoomName							  varchar(20) not null,
groupSuggestNumber						  varchar(20) not null,
groupLowerLimit							  int not null,
groupUpperLimit							  int not null,
groupGameTime				              datetime not null,
reserveGroupStartTime					  datetime not null,
reserveGroupEndTime			  			  datetime not null,
